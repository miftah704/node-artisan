...
function makeModel(name) {
  ...
  var folderPath = _path["default"].join.apply(_path["default"], [_dirname, '..', 'models'].concat(_toConsumableArray(parts)));
  var fileName = _commandUtils["default"].removeSuffixFromName(modelName, 'model');
  ...
  var filePath = _path["default"].join(folderPath, "".concat(kebabCaseName, ".model.ts"));
  var content = "import { Model } from 'sutando'\n\nexport default class ".concat(pascalClassName, " extends Model {\n  // static tableName = ''\n  // connection = ''\n}");
  var divider = _chalk["default"].gray(_figures["default"].line.repeat(60));
  console.log(_chalk["default"].bold.blue("\n".concat(_figures["default"].info, " [Model Generator]\n")));
  console.log(_chalk["default"].bold("\u2728 Summary:"));
  console.log("".concat(_chalk["default"].green(_figures["default"].pointerSmall), " Model Name   : ").concat(_chalk["default"].cyan("".concat(pascalClassName))));
  console.log("".concat(_chalk["default"].green(_figures["default"].pointerSmall), " File Name   : ").concat(_chalk["default"].cyan("".concat(kebabCaseName, ".model.ts"))));
  ...
  console.log(_chalk["default"].green("".concat(_figures["default"].tick, " Model created successfully!")));
