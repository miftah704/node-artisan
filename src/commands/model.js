...
export default class ${pascalClassName} extends Model {
  ...
  if (options.controller) {
    console.log(
      chalk.italic(chalk.dim(`${figures.info} Generating controller for model: ${modelName}`))
    )
  ...
  if (options.service) {
    console.log(
      chalk.italic(chalk.dim(`${figures.info} Generating service for model: ${modelName}`))
    )
  ...
  if (options.repository) {
    console.log(
      chalk.italic(chalk.dim(`${figures.info} Generating repository for model: ${modelName}`))
    )
