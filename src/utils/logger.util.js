...
export default class LogUtil {
  ...
  static logSummary(pascalClassName, kebabCaseName, folderPath, type) {
    ...
    console.log(
      `${chalk.green(figures.pointerSmall)} Class Name  : ${chalk.cyan(pascalClassName)}${Str.title(
        type
      )}`
    )
    console.log(
      `${chalk.green(figures.pointerSmall)} File Name   : ${chalk.cyan(kebabCaseName)}.${Str.lower(
        type
      )}.ts`
    )
